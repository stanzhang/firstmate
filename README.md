...
- **Question-shaped consultation** - send one immutable advisory review envelope through the captain's signed-in ChatGPT web session, with exclusive evidence artifacts, fail-closed ambiguous-delivery handling, and no automatic action ([current contract](docs/consultation.md)).
...
- [docs/consultation.md](docs/consultation.md) - the signed-in ChatGPT consultation path, question and response contracts, receipts, and retry safety.
